...
* [**AIJobTech, Ltd**](https://aijobtech.co/){: .no-underline-black-link }
  ...
  * **AI-Driven Job Matching Startup Launch and Funding**: Implemented AI recommendation systems algorithm to facilitate precise job matching for business positions.
      * Joined "[HKSTP Ideation Programme](https://www.hkstp.org/what-we-offer/incubation-acceleration-elite/ideation/){: .no-underline-black-link }" and secured HKD 1.2 million in seed funding.
      * Joined "[HKU iDendron@Wanchai](https://idendron.hku.hk/){: .no-underline-black-link }".
